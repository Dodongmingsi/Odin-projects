const myTodolist=[//this should be an array of objects, we can contain objects in each index of the array
       ...
       function render(){
            let todoHTML='';
            myTodolist.forEach(function(todoObject,index){// first parameter is each value of array 2nd is each index
                ...
                let html=`<div class="todo-name">${name}</div>
                    ...
                    <button onclick="myTodolist.splice(${index},1); render();" class="delete-todo-button">Delete</button> 
